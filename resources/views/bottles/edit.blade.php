...
@section('content')
    <div class="p-10 ">
        ...
        <form method="put" action="{{ route('update', ['id' => $bottle->id]) }}">
            ...
            <button type="submit"
                class="text-white bg-gradient-to-br from-red-800 to-red-400 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-pink-200 dark:focus:ring-pink-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">Modifer</button>
    </form>
</div>
@endsection
