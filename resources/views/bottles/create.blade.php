        ...
        <form method="post" action="{{ route('store') }}">
            ...
            <div class="mb-6">
                ...
                <select name="cultures" class="bg-gray-50 border-gray-300" id="cultures">
                    ...
                    <option value="5">Ecologique</option>
            ...
            <button type="submit"
                class="text-white bg-gradient-to-br from-red-800 to-red-400 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-pink-200 dark:focus:ring-pink-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">Ajouter</button>
        </form>
